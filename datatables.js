 ...
 *   https://datatables.net/download/#dt/jq-3.7.0/dt-2.1.0/af-2.7.0/b-3.1.0/date-1.5.2
 *
 * Included libraries:
 *   jQuery 3 3.7.0, DataTables 2.1.0, AutoFill 2.7.0, Buttons 3.1.0, DateTime 1.5.2
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "dt/jq-3.7.0/dt-2.1.0/af-2.7.0/b-3.1.0/date-1.5.2",
